...
def run():
    ...
    with grpc.insecure_channel(connection_name) as channel: # fixed
        ...
        try:
           search_response = stub.search_user(addressbook_pb2.user_email(email='demo@demo.com'))  # call the rpc function defined in proto file and implemented in the server
           if search_response.id is -1:
               insert_response = stub.insert_user(addressbook_pb2.user_info(id=7,first_name="John",last_name="Doe",email="demo@demo.com"))
